package
{
	...
	public class Animation_demo_s3d extends Sprite
	{
		...
		private function start(event:Event = null):void
		{
			...
			mStarling = new Starling(AnimationDemo, stage);
		...
		private function onRootCreated(event:Event, game:AnimationDemo):void
		{
