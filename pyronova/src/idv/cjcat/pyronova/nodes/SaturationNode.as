package idv.cjcat.pyronova.nodes {
	...
	public class SaturationNode extends PyroNode {
		...
		public function SaturationNode(input:PyroNode = null, level:Number = 1 / 3) {
		...
		public function set level(value:Number):void {
			_level = value;
			_filter.matrix = ColorMatrix.saturation(level);
		}
